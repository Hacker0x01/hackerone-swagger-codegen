package com.hackerone.codegen.v3.generators.python;
...
public class H1PythonClientCodegen extends DefaultCodegenConfig {

    private static final Logger LOGGER = LoggerFactory.getLogger(H1PythonClientCodegen.class);
